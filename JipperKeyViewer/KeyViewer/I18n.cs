...
namespace JipperKeyViewer.KeyViewer
{
    ...
    public static class I18n
    {
        ...
        static readonly Dictionary<string, string> en = new()
        {
            ...
            ["full_kb_keys_na"] = "Key binding / custom text is not available on the full-keyboard layout",
        ...
        static readonly Dictionary<string, string> zh = new()
        {
            ...
            ["full_kb_keys_na"] = "全键盘布局下不支持改键与自定义文本",
        ...
        static readonly Dictionary<string, string> ko = new()
        {
            ...
            ["full_kb_keys_na"] = "전체 키보드 레이아웃에서는 키 설정/사용자 지정 텍스트를 사용할 수 없습니다",
